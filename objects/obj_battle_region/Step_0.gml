//if(point_in_rectangle(obj_melee_mook.x, obj_melee_mook.y,left_edge_, top_edge_, right_edge_, bottom_edge_) == true)
//{
//	show_debug_message("melee mook is in rectangle");
//}
